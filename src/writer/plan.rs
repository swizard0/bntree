...
impl Script {
    pub fn start() -> Instruction {
        Instruction::Perform(Perform { op: Op::TreeStart, next: Script { inner: Fsm::Init, }, })
    }
